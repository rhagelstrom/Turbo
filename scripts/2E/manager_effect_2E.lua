...
function onInit()
    getEffectsByType = EffectManagerADND.getEffectsByType;
    hasEffect = EffectManagerADND.hasEffect;

    EffectManagerADND.getEffectsByType = customGetEffectsByType;
    EffectManagerADND.hasEffect = customHasEffect;
end

function onClose()
    EffectManagerADND.getEffectsByType = getEffectsByType;
    EffectManagerADND.hasEffect = hasEffect;
end
