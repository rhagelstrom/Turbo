...
function customGetEffectsByType(rActor, sEffectType, aFilter, rFilterActor, bTargetedOnly, aTraitFilter, bLeaveOneShots)
	...
	GlobalDebug.consoleObjects("EffectManager: getEffectsByType.  Starting data - rActor, sEffectType, aFilter, rFilterActor, bTargetedOnly, aTraitFilter", rActor, sEffectType, aFilter, rFilterActor, bTargetedOnly, aTraitFilter);
	...
	GlobalDebug.consoleObjects("EffectManager: getEffectsByType.  Done checking for save data.  sSaveType, sInitialResult, aFilter = ", sSaveType, sInitialResult, aFilter);
...
--				GlobalDebug.consoleObjects("EffectManager: getEffectsByType.  After getEffectsWithVariables - aEffectComps = ", aEffectComps);
				...
				for kEffectComp, sEffectComp in ipairs(aEffectComps) do
					...
					elseif rEffectComp.type == "IFT" then
						...
						GlobalDebug.consoleObjects("EffectManager: getEffectsByType.  About to check conditional.  rFilterActor, v, rEffectComp.remainder, rActor = ", rFilterActor, v, rEffectComp.remainder, rActor);
					...
					-- Compare other attributes
						...
						while aComponents[j] do
							...
							if (rEffectComp.type ~= "SAVE" and rEffectComp.type ~= "SAVERESULT") and (StringManager.contains(DataCommon.dmgtypes, sDamageTypeName) or
							...
							elseif (rEffectComp.type == "SAVE" or rEffectComp.type == "SAVERESULT" or rEffectComp.type == "SAVEDAMAGEPER") and
									(sSaveType == aComponents[j] or
									sInitialResult == aComponents[j] or
									StringManager.contains(DataCommon.bonustypes, aComponents[j]) or
									aComponents[j] == "all" or
						...
						-- Check for match
						GlobalDebug.consoleObjects("EffectManager: getEffectsByType.  Effect components - checking for match. bProcessFilters, bTargetedOnly, bTargeted, rEffectComp, aEffectRangeFilter, aEffectOtherFilter = ", bProcessFilters, bTargetedOnly, bTargeted,  rEffectComp, aEffectRangeFilter, aEffectOtherFilter);
...
function customHasEffect(rActor, sEffect, rTarget, bTargetedOnly, bIgnoreEffectTargets)
	GlobalDebug.consoleObjects("EffectManager: hasEffect. rActor, sEffect, rTarget, bTargetedOnly, bIgnoreEffectTargets = ", rActor, sEffect, rTarget, bTargetedOnly, bIgnoreEffectTargets);
